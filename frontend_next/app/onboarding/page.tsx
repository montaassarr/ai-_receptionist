...
import { CheckCircle2, Circle, Loader2, Sparkles, Key, Building2, Workflow, Bot, Phone } from "lucide-react";
...
const STEPS: OnboardingStep[] = [
  {
    id: 1,
    title: "Welcome",
    description: "Get started with your AI Receptionist",
    icon: Sparkles,
  },
  {
    id: 2,
  ...
  },
  {
    id: 4,
    title: "n8n Workflow",
    description: "Connect your workflow automation",
    icon: Workflow,
  },
  {
    id: 5,
...
export default function OnboardingPage() {
  ...
  // Check if in test mode (via query param or localStorage)
  useEffect(() => {
  ...
  const completeOnboarding = async () => {
    try {
      // TODO: Call API to mark tenant.onboarding_completed = true
      // await api.patch("/tenants/me", { onboarding_completed: true });
  ...
  const isStepValid = () => {
    switch (currentStep) {
      ...
      case 2:
        return formData.groqApiKey && formData.vapiApiKey;
      case 3:
        return formData.businessName && formData.businessDescription && formData.phone;
      case 4:
        return formData.n8nUrl && formData.n8nApiKey;
      case 5:
        return formData.agentName && formData.agentPrompt;
      case 6:
        return formData.testPhoneNumber;
      default:
        return true;
    }
  };
            ...
            {isTestMode && (
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                <p className="text-amber-800 font-medium">
                  🧪 Test Mode Active - Pre-filled data for fast testing
                </p>
              </div>
            )}
            <div className="grid grid-cols-2 gap-4 text-left mt-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">100 minutes included</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 text-green-500 mt-1" />
                <div>
                  <p className="font-semibold">BYOK Support</p>
                  <p className="text-sm text-muted-foreground">Use your own API keys</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 text-green-500 mt-1" />
                <div>
                  <p className="font-semibold">n8n Integration</p>
                  <p className="text-sm text-muted-foreground">Powerful workflow automation</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 text-green-500 mt-1" />
                <div>
                  <p className="font-semibold">Multi-Agent</p>
                  <p className="text-sm text-muted-foreground">Create unlimited agents</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                We use a Bring Your Own Key (BYOK) model - you stay in control of your AI costs
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                <p className="text-xs text-muted-foreground mt-1">
                  For GPT-4 models (optional, Groq is default)
                </p>
              </div>
            </div>
          </div>
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                This helps us personalize your AI agent's responses
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="We provide excellent customer service and..."
                  rows={4}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    id="industry"
                    placeholder="Healthcare, Legal, etc."
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                n8n powers your automation workflows and appointment management
              </p>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <p className="text-blue-800 text-sm mb-2">
                Make sure your n8n instance is running with the AI Receptionist workflows imported.
              </p>
              <a
                href="/workflows/README.md"
                target="_blank"
            ...
            <div className="space-y-4">
              <div>
                ...
                />
                <p className="text-xs text-muted-foreground mt-1">
                  Your n8n instance URL (local or hosted)
                </p>
              </div>
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Set up an AI agent to handle your calls
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  id="agentPrompt"
                  placeholder="You are a friendly AI receptionist for [Business]. Help customers with..."
                  rows={6}
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                />
                <p className="text-xs text-muted-foreground mt-1">
                  We'll call this number to test your agent
                </p>
              </div>
