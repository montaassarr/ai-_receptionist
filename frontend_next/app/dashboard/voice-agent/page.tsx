...
export default function VoiceAgentPage() {
    ...
    const assistantIdOverride = process.env.NEXT_PUBLIC_VAPI_ASSISTANT_ID;
    ...
    const featureMutation = useMutation({
        ...
        onError: (error: any) => {
            toast.error(error?.response?.data?.detail || "Failed to update voice settings");
        },
    });
    ...
    const handleStartWebCall = async () => {
        if (!vapiClient) {
            toast.error("Missing Vapi public key", {
                description: "Set NEXT_PUBLIC_VAPI_PUBLIC_KEY to enable in-browser calls",
            });
            return;
        }
        ...
        try {
            ...
            toast.success("Browser call started", { description: "You are live with the agent" });
        } catch (error: any) {
        ...
        <div className="p-6 space-y-6">
            ...
            {!publicKey && (
                <Alert variant="destructive">
                    ...
                    <AlertDescription>
                        Set <code className="font-mono">NEXT_PUBLIC_VAPI_PUBLIC_KEY</code> in your frontend .env file to test in-browser calls.
                    </AlertDescription>
                </Alert>
            )}
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                ...
                <div className="glass rounded-2xl p-5 space-y-3">
                    ...
                    <Link href="/dashboard/voice-agent/test" className="text-xs font-medium text-primary hover:underline">
