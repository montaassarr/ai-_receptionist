"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[9623],{59623:(e,t,i)=>{i.d(t,{yU:()=>D});var o=i(12115);let r=`#version 300 es
...
}`;var l=i(95155);async function c(e){let t={},i=[];return Object.entries(e).forEach(e=>{let[o,r]=e;if("string"==typeof r){if(!r){t[o]=function(){if("undefined"==typeof window)return void console.warn("Paper Shaders: can’t create an image on the server");let e=new Image;return e.src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",e}();return}if(!(e=>{try{if(e.startsWith("/"))return!0;return new URL(e),!0}catch(e){return!1}})(r))return void console.warn('Uniform "'.concat(o,'" has invalid URL "').concat(r,'". Skipping image loading.'));let e=new Promise((e,i)=>{let a=new Image;(e=>{try{if(e.startsWith("/"))return!1;return new URL(e,window.location.origin).origin!==window.location.origin}catch(e){return!1}})(r)&&(a.crossOrigin="anonymous"),a.onload=()=>{t[o]=a,e()},a.onerror=()=>{console.error("Could not set uniforms. Failed to load image at ".concat(r)),i()},a.src=r});i.push(e)}else t[o]=r}),await Promise.all(i),t}let h=(0,o.forwardRef)(function(e,t){let{fragmentShader:i,uniforms:r,webGlContextAttributes:a,speed:n=0,frame:A=0,width:h,height:u,minPixelRatio:g,maxPixelCount:p,mipmaps:m,style:f,...B}=e,[v,d]=(0,o.useState)(!1),x=(0,o.useRef)(null),E=(0,o.useRef)(null),w=(0,o.useRef)(a);(0,o.useEffect)(()=>((async()=>{let e=await c(r);x.current&&!E.current&&(E.current=new s(x.current,i,e,w.current,n,A,g,p,m),d(!0))})(),()=>{var e;null==(e=E.current)||e.dispose(),E.current=null}),[i]),(0,o.useEffect)(()=>{let e=!1;return(async()=>{let t=await c(r);if(!e){var i;null==(i=E.current)||i.setUniforms(t)}})(),()=>{e=!0}},[r,v]),(0,o.useEffect)(()=>{var e;null==(e=E.current)||e.setSpeed(n)},[n,v]),(0,o.useEffect)(()=>{var e;null==(e=E.current)||e.setMaxPixelCount(p)},[p,v]),(0,o.useEffect)(()=>{var e;null==(e=E.current)||e.setMinPixelRatio(g)},[g,v]),(0,o.useEffect)(()=>{var e;null==(e=E.current)||e.setFrame(A)},[A,v]);let Q=function(e){let t=o.useRef(void 0),i=o.useCallback(t=>{let i=e.map(e=>{if(null!=e){if("function"==typeof e){let i=e(t);return"function"==typeof i?i:()=>{e(null)}}return e.current=t,()=>{e.current=null}}});return()=>{i.forEach(e=>e?.())}},e);return o.useMemo(()=>e.every(e=>null==e)?null:e=>{t.current&&(t.current(),t.current=void 0),null!=e&&(t.current=i(e))},e)}([x,t]);return(0,l.jsx)("div",{ref:Q,style:void 0!==h||void 0!==u?{width:"string"==typeof h&&!1===isNaN(+h)?+h:h,height:"string"==typeof u&&!1===isNaN(+u)?+u:u,...f}:f,...B})});h.displayName="ShaderMount";let u=`
in vec2 v_objectUV;
