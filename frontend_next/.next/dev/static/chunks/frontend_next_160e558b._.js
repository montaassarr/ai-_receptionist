...
function VoiceAgentControlCenter() {
    _s();
    const [agent, setAgent] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend_next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [phoneNumbers, setPhoneNumbers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend_next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [callStats, setCallStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend_next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend_next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("overview");
    ...
    const loadData = async ()=>{
        try {
            ...
            const [agentRes, phoneRes, statsRes] = await Promise.all([
                fetch(__TURBOPACK__imported__module__$5b$project$5d2f$frontend_next$2f$lib$2f$api$2d$endpoints$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiEndpoints"].agents.getMyAgent(), {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                }),
                fetch(__TURBOPACK__imported__module__$5b$project$5d2f$frontend_next$2f$lib$2f$api$2d$endpoints$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiEndpoints"].voiceAgent.phoneNumbers(), {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                }),
                fetch(__TURBOPACK__imported__module__$5b$project$5d2f$frontend_next$2f$lib$2f$api$2d$endpoints$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiEndpoints"].voiceAgent.stats(), {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                })
    ...
    const handleToggleAgent = async (agentId, currentStatus)=>{
        try {
            ...
            const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$frontend_next$2f$lib$2f$api$2d$endpoints$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiEndpoints"].agents.update(agentId), {
                method: "PATCH",
                headers: {
...
//# sourceMappingURL=frontend_next_160e558b._.js.map