...
function AISettingsPage() {
    ...
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend_next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("models");
    ...
    const loadConfig = async ()=>{
        try {
            ...
            const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$frontend_next$2f$lib$2f$api$2d$endpoints$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiEndpoints"].agents.getMyAgent(), {
                headers: {
    ...
    const saveConfig = async ()=>{
        ...
        try {
            const token = localStorage.getItem("access_token");
            const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$frontend_next$2f$lib$2f$api$2d$endpoints$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiEndpoints"].agents.updateMyAgent(), {
                method: "PUT",
                headers: {
...
_s(AISettingsPage, "pc2L18VrLbdJCNf0E4QHZmAYjuo=", false, function() {
    return [
...
//# sourceMappingURL=frontend_next_c8daca27._.js.map