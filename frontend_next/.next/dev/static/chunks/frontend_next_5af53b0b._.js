...
function AssistantConfig() {
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            let result;
            if (assistantId) {
                result = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend_next$2f$lib$2f$api$2d$endpoints$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vapiApi"].updateMyAssistant(payload);
                toast({
                    title: "Success",
                    description: "AI Assistant updated successfully"
                });
            } else {
                result = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend_next$2f$lib$2f$api$2d$endpoints$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vapiApi"].createMyAssistant(payload);
...
_s(AssistantConfig, "wjmPVEVwfYBuBwzhHxxrsX7zxsA=", false, function() {
    return [
...
//# sourceMappingURL=frontend_next_5af53b0b._.js.map