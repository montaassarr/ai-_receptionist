    ...
    >
      <div className="flex items-center pointer-events-none">
        <svg
          ...
          strokeWidth="1"
          viewBox="0 0 16 16"
          className="h-6 w-6 -rotate-[70deg] transform stroke-green-600 text-green-700 drop-shadow-lg pointer-events-none"
          height="1em"
          width="1em"
        ...
        <motion.div
          style={{
            backgroundColor: "#1b5e3f", // Fixed forest green color
          }}
          initial={{
            scale: 0.5,
            opacity: 0,
