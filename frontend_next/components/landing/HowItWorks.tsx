    ...
    <section id="how-it-works" className="py-24 px-5 bg-sage relative overflow-hidden">
        <div className="max-w-[1000px] mx-auto">
            ...
            <motion.div 
                ...
                className="w-full aspect-video rounded-[27px] overflow-hidden bg-black/20 shadow-2xl relative"
            >
                <video 
                    src="https://framerusercontent.com/assets/P9bKBbUDarJUHv4om3gLPnDAcU.webm" 
                    loop 
                    muted 
                    playsInline 
                    autoPlay
