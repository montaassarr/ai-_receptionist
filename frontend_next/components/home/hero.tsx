...
export default function Hero() {
  ...
  return (
    <>
      ...
      <section ref={ref} className="relative overflow-hidden min-h-screen flex flex-col">
          ...
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                Automate your <strong>Business</strong> <span>with</span> <br />
                <strong>AIM²</strong> <em className="italic">Receptionist</em>
              </h1>
            </motion.div>
            ...
            >
              The AI-powered receptionist that handles calls, appointments, and customer inquiries 24/7.
            ...
            >
              ...
              <div className="flex items-center justify-center">
                <a href="/docs/components/theme-toggle-animations">
                  <div className="group cursor-pointer border border-cyan-500/30 bg-slate-950/50 gap-2 h-[60px] flex items-center p-[10px] rounded-full hover:bg-slate-900/50 transition-colors">
                    <div className="border border-cyan-500/30 bg-cyan-600 h-[40px] rounded-full flex items-center justify-center text-white shadow-[0_0_15px_rgba(8,145,178,0.3)]">
