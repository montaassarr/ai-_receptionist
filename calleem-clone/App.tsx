...
function App() {
  return (
    <div className="min-h-screen w-full bg-calleem-bg overflow-x-hidden font-sans text-white">
      <Navbar />
            ...
            <div className="flex flex-col gap-6 items-center">
                <div className="hidden md:block animate-fade-in-up">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#1c1c1c] bg-transparent shadow-lg backdrop-blur-sm">
                        ...
                        <span className="text-[12px] font-medium text-[#184a27] font-display">Contact us</span>
                    </div>
                </div>
                
                <h1 className="font-display font-bold text-[48px] leading-[1.1] md:text-[56px] text-white">
                  We’re here to help
                </h1>
