/**
 * Business Configuration Hook
 * Provides access to business configuration with React Query caching
 */

import { useQuery, useMutation, useQueryClient } from '@tanstack/react-query';
import { businessConfigApi, BusinessConfig, BusinessConfigUpdate, WhatsAppConfiguration } from '../api/business-config';
